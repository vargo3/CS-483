...
if args.certificate is not None:
	signer = args.certificate
else:
	signer = args.secret_key_file

#call rsa-sign similiarly to calling from command line
sign_call = "python rsa-sign.py -k " + signer + " -m " + args.public_key_file + " -s " + args.public_key_file + "-casig"
